		...
		"className": function( classNameName ) {
			...
			return pattern ||
				...
				classNameCache( classNameName, function( elem ) {
					return pattern.test( typeof elem.classNameName === "string" && elem.classNameName || typeof elem.getAttribute !== "undefined" && elem.getAttribute("className") || "" );
				});
		},
	...
	toggleclassName: function( value, stateVal ) {
		...
		return this.each( function() {
			...
			if ( type === "string" ) {
				...
				i = 0;
				self = jQuery( this );
				classNameNames = value.match( rnothtmlwhite ) || [];
